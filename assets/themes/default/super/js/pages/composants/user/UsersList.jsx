...
export class UsersList extends Component {
    render () {
        const {users, itemsFilter, onOpenAside, onConvertIsNew, onDelete} = this.props
        ...
        users.forEach(elem => {
            ...
            if(itemsFilter.value.includes(elem.highRoleCode)){
                items.push(<div className="item-user" key={elem.id}>
        ...
        return <> {items.length != 0 ? items : <p>Aucun résultat.</p>} </>
    }
}